...
const SignUpScreen = (props) => {
  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      let data = await FETCH('server' , 'POST','http://192.168.1.32:8000/v1/auth/signup','',value)
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={global.bContainer}>
        ...
        {errors.name && <Text style={global.error}>{errors.name}</Text>}
          ...
          {errors.confirm_password && <Text style={global.error}>{errors.confirm_password}</Text>}
          <TextinputA 
