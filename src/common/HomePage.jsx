import {    StyleSheet, View, Text ,Pressable, TextInput, Dimensions, ScrollView } from 'react-native';
...
flex:1,
   ...
   Container: {
      ...
      iconStackRow: {
        ...
        paddingHorizontal: getResponsiveValue("2%","4%"), 
      },
      iconStack: {
        flex: 1,
        flexDirection: "row",
      ...
      icon3: {
        ...
        marginLeft: getResponsiveValue("38%","8%"),
     ...
     borderWidth: getResponsiveValue(3,2),
      ...
      create: {
        marginLeft:getResponsiveValue(8,"8%"),
